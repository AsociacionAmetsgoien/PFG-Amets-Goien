    ...
    <footer className="text-white px-4 md:px-8 lg:px-12" style={{ backgroundColor: '#6b3f7a' }}>
      <div className="max-w-7xl mx-auto py-8 md:py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-12">
          ...
          <div>
            <h4 className="text-white font-semibold text-base md:text-lg mb-3 md:mb-4">{t('footer.collaborate')}</h4>
            <ul className="space-y-2 md:space-y-3 text-sm md:text-base">
              <li>
                <a href="/colaborar" className="text-white/80 hover:text-white transition-colors flex items-center">
              ...
              <li>
                <a href="/voluntarios" className="text-white/80 hover:text-white transition-colors flex items-center font-semibold">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a href="https://www.instagram.com/ametsgoien/" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-white transition-colors flex items-center">
                  {/* Instagram SVG */}
          ...
          {/* Columna 3: Contacto */}
          <div>
            <h4 className="text-white font-semibold text-base md:text-lg mb-3 md:mb-4">{t('footer.contact')}</h4>
            <ul className="space-y-2 md:space-y-3 text-sm md:text-base">
              ...
              <li className="flex items-center text-white/80">
                ...
                <a href="tel:+34697858343" className="hover:text-white transition-colors">
                  +34 697 858 343
                </a>
              </li>
            </ul>
