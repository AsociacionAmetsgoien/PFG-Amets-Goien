...
const Colaborador = {
  ...
  create: async (colaboradorData) => {
    const query = `
      INSERT INTO colaboradores(nombre, apellidos, email, telefono, direccion, anotacion)
      VALUES ($1,$2,$3,$4,$5,$6)
      RETURNING *;
    `;
    const values = [
      colaboradorData.nombre, colaboradorData.apellidos, colaboradorData.email, colaboradorData.telefono,
      colaboradorData.direccion, colaboradorData.anotacion
    ];
  ...
  update: async (id, colaboradorData) => {
    const query = `
      ...
      direccion=$5, anotacion=$6
      WHERE id=$7 RETURNING *;
    `;
    const values = [
      colaboradorData.nombre, colaboradorData.apellidos, colaboradorData.email, colaboradorData.telefono,
      colaboradorData.direccion, colaboradorData.anotacion, id
    ];
