...
router.post('/', auth, checkRole('admin', 'empleado'), validate(tareaSchema), createTarea);
router.put('/:id', auth, checkRole('admin', 'empleado'), validate(tareaSchema), updateTarea);
